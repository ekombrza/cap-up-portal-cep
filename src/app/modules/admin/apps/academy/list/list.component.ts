...
import { AcademyService } from 'src/app/modules/admin/apps/academy/academy.service';
import { Category, Course } from 'src/app/modules/admin/apps/academy/academy.types';
...
export class AcademyListComponent implements OnInit, OnDestroy
{
    ...
    filters: {
        ...
        categorySlug$ : new BehaviorSubject('tous'),
