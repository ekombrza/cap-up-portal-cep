...
import { NavigationItem, NavigationService } from 'src/@ekbz/components/navigation';
import { MockApiService } from 'src/@ekbz/lib/mock-api';
import { defaultNavigation } from 'src/app/mock-api/common/navigation/data';
import { contacts } from 'src/app/mock-api/apps/contacts/data';
import { tasks } from 'src/app/mock-api/apps/tasks/data';
...
export class SearchMockApi
{
     ...
     */
    constructor(
        private _fuseMockApiService: MockApiService,
