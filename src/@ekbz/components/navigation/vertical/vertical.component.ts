...
import { NavigationItem, VerticalNavigationAppearance, VerticalNavigationMode, VerticalNavigationPosition } from 'src/@ekbz/components/navigation/navigation.types';
...
export class VerticalNavigationComponent implements OnChanges, OnInit, AfterViewInit, OnDestroy
{
    ...
    set fuseScrollbarDirectives(scrollbarDirectives: QueryList<ScrollbarDirective>)
    {
        ...
        setTimeout(() => {
            ...
            else
            {
                ...
                this._scrollbarDirectives.forEach((scrollbarDirective) => {
                    ...
                    scrollbarDirective.scrollToElement('.fuse-vertical-navigation-item-active', -120, true);
                });
            }
        });
    }
