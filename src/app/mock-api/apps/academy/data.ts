...
export const categories = [
    ...
    {
        id   : '5648a630-979f-4403-8c41-fc9790dea8ce',
        title: 'Enfants et étudiants',
        slug : 'enfants-etudiants'
    },
    {
        id   : '5648a630-979f-4403-8c41-fc9790dea8cf',
        title: 'Héritage',
        slug : 'heritage'
    },
    {
         id   : '5648a630-979f-4403-8c41-fc9790dea8cg',
         title: 'Prière',
         slug : 'priere'
    },
    {
         id   : '5648a630-979f-4403-8c41-fc9790dea8ch',
         title: 'Groupes de maison',
         slug : 'gdm'
    },
    {
         id   : '5648a630-979f-4403-8c41-fc9790dea8ci',
         title: 'Service de Culte',
         slug : 'culte'
    },
    {
         id   : '5648a630-979f-4403-8c41-fc9790dea8cj',
         title: 'Louange et production',
         slug : 'louange-production'
    },
];
export const courses = [
    {
        id         : '694e4e5f-f25f-470b-bd0e-26b1d4f64028',
        title      : 'Quelques pensées sur la prière et vos 3 jours de jeûnes et prières',
        slug       : 'pensees-priere',
        image      : 'https://statique.cepevry.fr/ressources.cepevry.fr/DATA/FORMATIONS/PENSEES-SUR_LA_PRIERE/Pensees_Sur_La_Priere.png',
        description: 'Dans cet ouvrage, nous aborderons le modèle de prière de Jésus ainsi que quelques conseils pratiques lors de moments de jeûne et prières',
        category   : ['croissance','priere'],
        duration   : 30,
        totalSteps : 11,
    ...
    },
    {
        ...
        title      : '4 piliers du ministère',
        slug       : '4-pilliers-du-ministere',
        image      : 'https://statique.cepevry.fr/ressources.cepevry.fr/DATA/FORMATIONS/QUATRE_PILIERS_MINISTERE/4_PILIERS_MINISTERE.png',
        description: 'Ce petit manuel a pour but de vous communiquer quelques éléments clés pour accomplir efficacement cette œuvre avec l’aide du Seigneur.',
        category   : ['croissance'],
        duration   : 60,
        totalSteps : 11,
    ...
    },
    {
        ...
        title      : 'A la découverte de la foi',
        slug       : 'a-la-decouverte-de-la-foi',
        image      : 'https://statique.cepevry.fr/ressources.cepevry.fr/DATA/FORMATIONS/A_LA_DECOUVERTE_DE_LA_FOI/couverture.png',
        description: 'Vous vous posez des questions sur Dieu, la foi, Christ, le salut et bien d’autre encore ? Ce livret a pour but de vous accompagner dans votre cheminement avec Dieu. Je vous y propose de découvrir ce que la bible nous dit sur quelques sujets essentiels pour une marche épanouie avec Christ.',
        category   : ['croissance','enfants-etudiants'],
        duration   : 120,
        totalSteps : 11,
    ...
    },
    {
        ...
        title      : 'Ma vie avec Jésus (1ère année)',
        slug       : 'ma-vie-avec-jesus-1ere-annee',
        image      : 'https://www.cepevry.fr/wp-content/uploads/2021/11/MVAJ-appli.jpg',
        description: 'Cette ressource contient l\'ensemble des cours de la première année de la formation "ma vie avec Jésus". Elle contient 12 leçons.',
        category   : ['croissance','enfants-etudiants','heritage'],
        duration   : 30,
        totalSteps : 11,
